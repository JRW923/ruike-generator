            ...
            <${upperDataKey}VO> get${upperDataKey}VOById(long id, HttpServletRequest request) {
                ...
                */
                ...
                <${upperDataKey}VO>> list${upperDataKey}VOByPage(@RequestBody ${upperDataKey}QueryRequest ${dataKey}
                    ...
                    * @return
                    */
                    @GeneratorMapping("/my/list/page/vo")
                    public BaseResponse
                    <Page
